from Editor import Editor, Object, Triggers
from Dictionaries.PropertyHSV import HSV

# This is an example of how to use the library:
#   1. Load the most recent level using Editor.loadCurrentLevel()
#   2. Make all the necessary changes (add/delete objects)
#   3. Save your changes with editor.save()
...
if __name__ == '__main__':
    ...
    editor.add(Object(
        id=Triggers.spawn, #Spawn trigger
